...
const add_1 = (0, tslib_1.__importDefault)(require("@graphql-codegen/add"));
...
exports.preset = {
    buildGeneratesSection: options => {
        ...
        }, operationNameFilter, (0, visitor_plugin_common_1.getConfigValue)(options.config.dedupeFragments, false));
        ...
        for (const [filename, record] of filePathsMap.entries()) {
            if (((_c = (_b = record.documents[0]) === null || _b === void 0 ? void 0 : _b.document) === null || _c === void 0 ? void 0 : _c.definitions.length) === 0) {
                continue;
            }

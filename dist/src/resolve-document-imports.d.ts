 ...
 */
export declare function resolveDocumentImports<T>(presetOptions: Types.PresetFnArgs<T>, schemaObject: GraphQLSchema, importResolverOptions: DocumentImportResolverOptions, operationNameFilter: RegExp, dedupeFragments?: boolean): Array<ResolveDocumentImportResult>;
export {};

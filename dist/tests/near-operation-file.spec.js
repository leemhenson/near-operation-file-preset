...
describe('near-operation-file preset', () => {
  ...
  `);
    ...
    const operationAst = (0, graphql_1.parse)(/* GraphQL */ `
    query {
      user {
        id
        ...UserFields
  ...
  `);
    const minimalOperationAst = (0, graphql_1.parse)(/* GraphQL */ `
    query {
      user {
        ...UserFields
      }
  ...
  `);
    ...
    describe('Issues', () => {
        it('#5002 - error when inline fragment does not specify the name of the type', async () => {
            const testSchema = (0, graphql_1.parse)(/* GraphQL */ `
        scalar Date
      ...
      `);
          ...
          `),
            ...
            expect(async () => {
                await index_1.preset.buildGeneratesSection({
                    baseOutputDir: './src/',
                    config: {},
                    presetConfig: {
                    ...
                    schema: testSchema,
                    schemaAst: (0, graphql_1.buildASTSchema)(testSchema),
        ...
        `);
                const result = await index_1.preset.buildGeneratesSection({
                    ...
                    schema: (0, plugin_helpers_1.getCachedDocumentNodeFromSchema)(testSchema),
                    documents: [
                        {
                            location: '/some/deep/path/src/graphql/queries.graphql',
                            document: (0, graphql_1.parse)(operationsStr),
                        },
                        {
        ...
        it('#6439 - generating code only for the last query inside a file', async () => {
            const result = await (0, cli_1.executeCodegen)({
                schema: [
                    /* GraphQL */ `
            type Query {
              a: String
          ...
          `,
                ...
                documents: path_1.default.join(__dirname, 'fixtures/issue-6439.ts'),
                generates: {
                    'out1.ts': {
                        preset: index_1.preset,
                        presetConfig: {
                            baseTypesPath: 'types.ts',
                        },
        ...
        it('#6520 - self-importing fragment', async () => {
          ...
          `,
                ...
                documents: [path_1.default.join(__dirname, 'fixtures/issue-6520.ts')],
                generates: {
                    'out1.ts': {
                        preset: index_1.preset,
                        presetConfig: {
        ...
        it('#6546 - duplicate fragment imports', async () => {
          ...
          `,
                ...
                documents: [
                    path_1.default.join(__dirname, 'fixtures/issue-6546-queries.ts'),
                    path_1.default.join(__dirname, 'fixtures/issue-6546-fragments.ts'),
                ],
                generates: {
                    'out1.ts': {
                        preset: index_1.preset,
    ...
    it('should fail when multiple fragments with the same name but different definition are found', () => {
        expect(() => index_1.preset.buildGeneratesSection({
            baseOutputDir: './src/',
            config: {},
            presetConfig: {
                cwd: '/some/deep/path',
    ...
    it('Should import relevant nested fragments on dedupeFragments', async () => {
        const schema = (0, graphql_1.parse)(/* GraphQL */ `
      type Address {
        city: String
      }
    ...
    `);
        ...
        const result = await index_1.preset.buildGeneratesSection({
            ...
            schema,
            schemaAst: (0, graphql_1.buildASTSchema)(schema),
            documents: operations,
            plugins: [{ typescript: {} }, { 'typescript-operations': {} }, { 'typed-document-node': {} }],
            pluginMap: { typescript: {}, 'typescript-operations': {}, 'typed-document-node': {} },
        });
...
const getFragmentImportsFromResult = (result, index = 0) => result[index].config.fragmentImports
    .map((importStatement) => (0, visitor_plugin_common_1.generateFragmentImportStatement)(importStatement, 'both'))
    .join('\n');
